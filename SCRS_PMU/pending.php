...
<head>
    ...
    <style>
        ...
        /* Additional style to place text exactly in the center of the screen */
...
<body>
    ...
    <!-- The Bootstrap script is required for the Offcanvas to function -->
